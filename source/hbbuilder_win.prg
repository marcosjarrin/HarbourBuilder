...
static function TBRun()
   ...
   cAllPrg += 'HB_FUNC( UI_SETPROP )        { /* no-op at runtime */ }' + Chr(10)
   cAllPrg += 'HB_FUNC( UI_GETPROP )        { hb_ret(); }' + Chr(10)
   cAllPrg += 'HB_FUNC( UI_BROWSESETCOLPROP ) { /* no-op at runtime */ }' + Chr(10)
   cAllPrg += 'HB_FUNC( UI_BROWSECOLCOUNT ) { hb_retni( 0 ); }' + Chr(10)
